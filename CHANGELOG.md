...
* /admin/incidents page, service filters, dashboard polish ([dc87b62](https://github.com/nic2045/My-M365-Statuspage/commit/dc87b6259cfa42b96517bfdc106f2ab779cf5bd7))
* /admin/incidents page, service filters, dashboard polish ([6bc562e](https://github.com/nic2045/My-M365-Statuspage/commit/6bc562e824c40fee8b4bf189aeec3f04b5c50628))
* Azure AD settings UI, connection verify on save, history card polish ([cff0246](https://github.com/nic2045/My-M365-Statuspage/commit/cff0246b5874768d77a60191aae18258de8ae18a))
* Azure AD settings UI, verify-on-save, history card polish ([de42dd3](https://github.com/nic2045/My-M365-Statuspage/commit/de42dd3feced97ba08e3bbdf71db9aedeb9b0bcf))
* click-through from day modal + service filter on history ([802b906](https://github.com/nic2045/My-M365-Statuspage/commit/802b9062492f40437c97fab7e9784079c4096cd2))
* click-through from day modal + service filter on history ([13e068b](https://github.com/nic2045/My-M365-Statuspage/commit/13e068b87a1cd6d4dbea7287a0ba373e580a8456))
...
* email settings UI with SMTP password + MS Graph OAuth2 support ([29542c6](https://github.com/nic2045/My-M365-Statuspage/commit/29542c6cec20dbc78c1ff766a8cba5b80e925bb5))
* email settings UI with SMTP password + MS Graph OAuth2 support ([d4fdc34](https://github.com/nic2045/My-M365-Statuspage/commit/d4fdc346b3aa153e20a4439b88d05d32bc868c98)), closes [#35](https://github.com/nic2045/My-M365-Statuspage/issues/35)
* filter dropdown, source/ref on incidents, tab nav UX, badge sizes ([abc0ea6](https://github.com/nic2045/My-M365-Statuspage/commit/abc0ea6bc8b59a2c8ec6361fc62cd5efeeae7be9))
* filter dropdowns, source/ref fields, tab nav UX, badge sizes ([d34ead0](https://github.com/nic2045/My-M365-Statuspage/commit/d34ead038844344c3ffb6ccf13670f7ac341321d))
* modern-look bundle — toasts, pulse, empty states, color audit ([415a88c](https://github.com/nic2045/My-M365-Statuspage/commit/415a88c7121e415f926c9f067c80d47eb6e81838))
* modern-look bundle — toasts, pulse, empty states, color audit ([11ab687](https://github.com/nic2045/My-M365-Statuspage/commit/11ab687fa640f8cc751f48e047909018cdd813f4))
* public page split (incidents/advisories) + bar hover tooltip + debug timeline ([d109004](https://github.com/nic2045/My-M365-Statuspage/commit/d109004522be24aa5bf48abbc230c0152560b4ab))
* public page split, bar hover tooltip, debug timeline ([9252501](https://github.com/nic2045/My-M365-Statuspage/commit/92525015e621f985ea3fb605f1fe734763d7ea9a))
* PWA support (manifest, service worker, install prompt) ([faa5990](https://github.com/nic2045/My-M365-Statuspage/commit/faa5990a0710661140e5694abc781e6b1add63c9)), closes [#52](https://github.com/nic2045/My-M365-Statuspage/issues/52)
* PWA support (manifest, service worker, install prompt) [#52](https://github.com/nic2045/My-M365-Statuspage/issues/52) ([7787e1b](https://github.com/nic2045/My-M365-Statuspage/commit/7787e1b808193aaf3868d4e2ce63e3cc801aa111))
* restore advisories section on admin dashboard ([4fa33c6](https://github.com/nic2045/My-M365-Statuspage/commit/4fa33c64b4d3d20f4dc0e48030cfb5e3672c48a0))
* restore advisories section on admin dashboard ([fa4525d](https://github.com/nic2045/My-M365-Statuspage/commit/fa4525de99dc80ba54a6c12fdd3fba95eb694861))
* sortable service order via admin (up/down arrows) ([6e7c193](https://github.com/nic2045/My-M365-Statuspage/commit/6e7c1939cdd06a8f8f05403c48e0fe791ad4b047))
* sortable service order via admin (up/down arrows) ([917b9db](https://github.com/nic2045/My-M365-Statuspage/commit/917b9dbe1f992c0e9035d0be2f9149830603cc83))
* top tab nav with subscribe modal + sidebar back-to-public + drop dashboard advisories ([97fe22e](https://github.com/nic2045/My-M365-Statuspage/commit/97fe22e3f3bff13f427aa4910ad840275b855de8))
* top tab nav with subscribe modal, sidebar back-to-public, drop dashboard advisories ([1cd3290](https://github.com/nic2045/My-M365-Statuspage/commit/1cd32900e60bd6cc416dd0ee4a4b9e82b4651063))
* top tab nav with subscribe modal, sidebar back-to-public, drop dashboard advisories ([0fd7a70](https://github.com/nic2045/My-M365-Statuspage/commit/0fd7a709d58ea8ec6ef76d6d7ae82cea7b3fb9f3))
