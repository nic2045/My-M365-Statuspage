...
LABELS_DE: dict[str, str] = {
    ...
    "admin.postmortem_heading":   "Postmortem",
    "admin.postmortem_impact":    "Auswirkungen",
    "admin.postmortem_root_cause": "Ursache",
    "admin.postmortem_action_items": "Maßnahmen",
    "admin.postmortem_timeline":  "Zeitleiste",
    "admin.postmortem_publish":   "Postmortem veröffentlichen",
    "admin.postmortem_unpublish": "Postmortem zurückziehen",
    ...
    "admin.translate":            "Übersetzen",
    "admin.translate_again":      "Erneut übersetzen",
    "admin.translated_hint":      "Manuell übersetzt – wird nicht mehr automatisch mit Microsoft synchronisiert.",
    "toast.translated":           "Übersetzt",
    "toast.translate_failed":     "Übersetzung fehlgeschlagen",
    "toast.translate_not_configured": "DeepL ist nicht konfiguriert (DEEPL_API_KEY fehlt)",
    "admin.publish_update":       "Veröffentlichen",
    "admin.pending_updates_hint": "Ungeprüfte Microsoft-Updates warten auf Veröffentlichung",
    "toast.update_published":     "Update veröffentlicht",
    ...
    "empty.admin.subscribers":    "Noch keine Abonnenten.",
    "empty.admin.templates":      "Noch keine Vorlagen erstellt.",
    "empty.admin.templates_cta":  "Erste Vorlage erstellen",
    ...
    "subscribe.channel_label":        "Kanal",
    "subscribe.channel_email":        "E-Mail",
    "subscribe.channel_teams":        "Microsoft Teams",
    "subscribe.teams_webhook_label":  "Teams Webhook-URL",
    "subscribe.teams_webhook_hint":   "Incoming-Webhook-Connector deines Teams-Kanals (Kanal → Connectors → Incoming Webhook).",
    "subscribe.all_services":         "Alle Dienste",
...
LABELS_EN: dict[str, str] = {
    ...
    "admin.postmortem_heading":   "Postmortem",
    "admin.postmortem_impact":    "Impact",
    "admin.postmortem_root_cause": "Root Cause",
    "admin.postmortem_action_items": "Action Items",
    "admin.postmortem_timeline":  "Timeline",
    "admin.postmortem_publish":   "Publish postmortem",
    "admin.postmortem_unpublish": "Unpublish postmortem",
    ...
    "admin.translate_again":      "Translate again",
    "admin.translated_hint":      "Manually translated - no longer synced automatically from Microsoft.",
    "toast.translated":           "Translated",
    "toast.translate_failed":     "Translation failed",
    "toast.translate_not_configured": "DeepL isn't configured (DEEPL_API_KEY missing)",
    "admin.publish_update":       "Publish",
    "admin.pending_updates_hint": "Unreviewed Microsoft updates waiting to be published",
    "toast.update_published":     "Update published",
    ...
    "empty.admin.subscribers":    "No subscribers yet.",
    "empty.admin.templates":      "No templates created yet.",
    "empty.admin.templates_cta":  "Create first template",
    ...
    "subscribe.channel_label":        "Channel",
    "subscribe.channel_email":        "Email",
    "subscribe.channel_teams":        "Microsoft Teams",
    "subscribe.teams_webhook_label":  "Teams webhook URL",
    "subscribe.teams_webhook_hint":   "Your Teams channel's incoming webhook connector (Channel → Connectors → Incoming Webhook).",
    "subscribe.all_services":         "All services",
